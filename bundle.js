...
/***/ "../sources/js/search-simplified.js":
/*!******************************************!*\
  !*** ../sources/js/search-simplified.js ***!
  \******************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module 'instantsearch.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module 'algoliasearch'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module 'instantsearch.js/es/widgets'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/*\n * Copyright 2019 Adobe. All rights reserved.\n * This file is licensed to you under the Apache License, Version 2.0 (the \"License\");\n * you may not use this file except in compliance with the License. You may obtain a copy\n * of the License at http://www.apache.org/licenses/LICENSE-2.0\n *\n * Unless required by applicable law or agreed to in writing, software distributed under\n * the License is distributed on an \"AS IS\" BASIS, WITHOUT WARRANTIES OR REPRESENTATIONS\n * OF ANY KIND, either express or implied. See the License for the specific language\n * governing permissions and limitations under the License.\n */\n\n\n\n\nfunction getTemplate(templateName) {\n  return document.querySelector(\"#\".concat(templateName, \"-template\")).innerHTML;\n}\n\nfunction app(opts) {\n  var author = document.getElementsByTagName('title')[0].text;\n  var main = document.getElementsByTagName('main')[0];\n  var elHits = document.createElement('div');\n  elHits.setAttribute('id', 'related-posts');\n  main.appendChild(elHits);\n  var search = !(function webpackMissingModule() { var e = new Error(\"Cannot find module 'instantsearch.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({\n    searchClient: !(function webpackMissingModule() { var e = new Error(\"Cannot find module 'algoliasearch'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(opts.appId, opts.apiKey),\n    appId: opts.appId,\n    apiKey: opts.apiKey,\n    indexName: opts.indexName\n  });\n  search.addWidgets([!(function webpackMissingModule() { var e = new Error(\"Cannot find module 'instantsearch.js/es/widgets'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({\n    hitsPerPage: 10,\n    facetFilters: [\"author:\".concat(author)]\n  })]);\n  search.addWidget(!(function webpackMissingModule() { var e = new Error(\"Cannot find module 'instantsearch.js/es/widgets'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({\n    container: '#related-posts',\n    templates: {\n      item: getTemplate('hit'),\n      empty: getTemplate('no-results')\n    }\n  }));\n  search.start();\n}\n\napp({\n  appId: 'A8PL9E4TZT',\n  // Note from the Algolia Docu:\n  // This is the public API key which can be safely used in your frontend code.This key is usable\n  // for search queries and it's also able to list the indices you've got access to.\n  apiKey: 'c5f99b37bfef18fd6ad1c440b5abd6c9',\n  indexName: 'anfibiacreativa--helix-norddal'\n});\n\n//# sourceURL=webpack:///../sources/js/search-simplified.js?");
